...
> Ευχαριστίες στους συνεργάτες του μαθήματος Δημήτρη Ψούνη, Στέφανο Σταμάτη, Νίκο Ποθητό, Μάνο Καρβούνη, Γιώργο Καστρίνη, Βασίλη Αναστασίου και στον Δρ. Ιωάννη Χαμόδρακα για τη συνεισφορά τους στη συγγραφή των εργαστηριακών φυλλαδίων του μαθήματος. Το υλικό των φυλλαδίων είναι βασισμένο στο αντίστοιχο υλικό που είχε αναπτυχθεί για το μάθημα από τον καθ. Παναγιώτη Σταματόπουλο τον οποίο και ευχαριστούμε θερμά.
