...
Σκοπός των πρώτων εργαστηρίων είναι η εξοικείωση με τα βασικά εργαλεία του μαθήματος. Συγκεκριμένα θα μάθουμε:
...
2. Εγκαθιστώντας την εφαρμογή PuTTY και χρησιμοποιώντας την ως την εφαρμογή SSH.
