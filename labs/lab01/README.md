...
/home/users/sdiXXYYYYY. Για να αναφερθούμε τώρα σε κάποιον άλλο κατάλογο
έχουμε δύο τρόπους:
...
χρησιμοποιούμε αναλόγως με τον ζητούμενο στόχο.

> Ένα ιδιαίτερα χρήσιμο κείμενο, με περαιτέρω τρόπους σύνταξης
  εντολών, πέρα από αυτές που θα αξιοποιήσουμε σήμερα, μπορεί να
  βρεθεί εδώ: <https://progintro.github.io/assets/pdf/Unix.pdf>
...
δικαίωμα ανάγνωσης (4), το 2ο bit το δικαίωμα
εγγραφής (2) και το 3ο bit το δικαίωμα εκτέλεσης
(1). Για παράδειγμα, το 7 (=111 δυαδικό) δίνει και
τα τρία δικαιώματα, ενώ το 5 (=101) δίνει
