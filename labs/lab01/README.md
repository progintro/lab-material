...
- [Βήμα 1: Πλοήγηση στο σύστημα αρχείων](#βήμα-1-πλοήγηση-στο-σύστημα-αρχείων)
- [Βήμα 2: Μεταγλώττιση, σύνδεση και εκτέλεση](#βήμα-2-μεταγλώττιση-σύνδεση-και-εκτέλεση)
- [Βήμα 3: Αντιγραφή, μετονομασία και προβολή αρχείων](#βήμα-3-αντιγραφή-μετονομασία-και-προβολή-αρχείων)
...
## Βήμα 1: Πλοήγηση στο σύστημα αρχείων
...
## Βήμα 2: Μεταγλώττιση, σύνδεση και εκτέλεση
...
## Βήμα 3: Αντιγραφή, μετονομασία και προβολή αρχείων
...
## Βήμα 5: Αναζήτηση, ανακατεύθυνση και σωληνώσεις
