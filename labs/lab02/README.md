...
- [Βήμα 1: Το περιβάλλον προγραμματισμού Visual Studio Code](#βήμα-1-το-περιβάλλον-προγραμματισμού-visual-studio-code)
- [Βήμα 2: Μεταφορά αρχείων με scp / WinSCP](#βήμα-2-μεταφορά-αρχείων-με-scp--winscp)
- [Βήμα 3: Μεταγλώττιση προγραμμάτων σε Unix και VS Code](#βήμα-3-μεταγλώττιση-προγραμμάτων-σε-unix-και-vs-code)
- [Άσκηση 1: Ένα απλό κομπιουτεράκι (calc.c)](#άσκηση-1-ένα-απλό-κομπιουτεράκι-calcc)
  - [1.1 Υψηλή ακρίβεια (Προχωρημένο, Προαιρετικό)](#11-υψηλή-ακρίβεια-προχωρημένο-προαιρετικό)
  - [1.2 Περισσότερες πράξεις (Προχωρημένο, Προαιρετικό)](#12-περισσότερες-πράξεις-προχωρημένο-προαιρετικό)
  - [1.3 Χειρισμός σφαλμάτων (Προχωρημένο, Προαιρετικό)](#13-χειρισμός-σφαλμάτων-προχωρημένο-προαιρετικό)
- [Άσκηση 2: Πυθαγόρειο θεώρημα (pyth.c)](#άσκηση-2-πυθαγόρειο-θεώρημα-pythc)
- [Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 1η)](#παράρτημα-αποσφαλμάτωση-προγραμμάτων-πράξη-1η)
...
## Βήμα 1: Το περιβάλλον προγραμματισμού Visual Studio Code
...
## Βήμα 2: Μεταφορά αρχείων με scp / WinSCP
...
## Βήμα 3: Μεταγλώττιση προγραμμάτων σε Unix και VS Code
...
## Άσκηση 1: Ένα απλό κομπιουτεράκι (calc.c)
...
## Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 1η)
