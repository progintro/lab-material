...
| WHILE | DO...WHILE |
|-------|------------|
| while (E<sub>2</sub>) { ...... } | do { ...... } while (E<sub>2</sub>); |
| Ε<sub>2</sub>: Συνθήκη Εισόδου και Συνέχισης Επανάληψης | Ε<sub>2</sub>: Συνθήκη Συνέχισης Επανάληψης |

> H δομή επανάληψης for:

| FOR | Όπου |
|-----|------|
| for(E<sub>1</sub>; E<sub>2</sub>; E<sub>3</sub>) { ............ } | Ε<sub>1</sub>: Εντολή Αρχικοποίησης <br> Ε<sub>2</sub>: Συνθήκη Εισόδου και Συνέχισης Επανάληψης (εφόσον ισχύει, εισερχόμαστε στον βρόχο ή επαναλαμβάνεται ο βρόχος) <br> Ε<sub>3</sub>: Εντολή Επανάληψης (εκτελείται στο τέλος της κάθε επανάληψης και πριν αρχίσει η επόμενη) |

> Ισοδύναμη δομή while με την δομή for:

| FOR | WHILE |
|-----|-------|
| for(E<sub>1</sub>; E<sub>2</sub>; E<sub>3</sub>) { ............ } | E<sub>1</sub>; <br> while (E<sub>2</sub>) { ...... E<sub>3</sub>; } |
...
| Τύποι Δεδομένων | Τύποι Δεδομένων (συνέχεια) |
|-----------------|----------------------------|
| d: int <br> ld: long <br> lld: long long <br> u: unsigned int <br> lu: unsigned long <br> llu: unsigned long long | f: float ή double <br> Lf: long double |
...
<Tύπος Επιστροφής> <Όνομα Συνάρτησης>(<Τυπικές Παράμετροι>) { <Εντολές και Δηλώσεις> }


| Τύπος Επιστροφής | Τυπικές Παράμετροι | Προαναγγελία Πρωτότυπου Συνάρτησης |
|------------------|--------------------|------------------------------------|
| Τύπος δεδομένων της τιμής που επιστρέφεται από τη συνάρτηση μέσω της εντολής: `return <παράσταση>;`. <br> Σε περίπτωση μη επιστροφής τιμής, ο `Τύπος Επιστροφής` ορίζεται σαν `void`. | Μεταβλητές, μαζί με τους τύπους τους, που χρησιμοποιούνται στη συνάρτηση, χωρισμένες με κόμμα, στις οποίες δίνονται τιμές από την καλούσα συνάρτηση. | Όταν καλείται πριν ορισθεί: <br> `<Tύπος Επιστροφής> <Όνομα Συνάρτησης>(<Τυπικές Παράμετροι>);` <br> `int main(void)` <br> `{` <br> ` ....` <br> `}` <br> `<Tύπος Επιστροφής> <Όνομα Συνάρτησης>(<Τυπικές Παράμετροι>)` <br> `{` <br> ` ....` <br> `}` |
