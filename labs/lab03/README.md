...
- [Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 2η)](#παράρτημα-αποσφαλμάτωση-προγραμμάτων-πράξη-2η)
  - [Λογικά λάθη](#λογικά-λάθη)
  - [Τεχνικές εύρεσης και διόρθωσης λογικών λαθών](#τεχνικές-εύρεσης-και-διόρθωσης-λογικών-λαθών)
  - [Άσκηση 4: Αποσφαλμάτωση αθροίσματος με όριο (limit.c)](#άσκηση-4-αποσφαλμάτωση-αθροίσματος-με-όριο-limitc)
...
## Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 2η)
...
### Άσκηση 4: Αποσφαλμάτωση αθροίσματος με όριο (limit.c)
