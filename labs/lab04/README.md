...
>
> - Να διαβάζετε και να γράφετε έναν χαρακτήρα τη φορά με `getchar` και `putchar`.
> - Να αναγνωρίζετε το τέλος της εισόδου (`EOF`) και να το χειρίζεστε σωστά.
> - Να συσχετίζετε χαρακτήρες με τους ASCII κωδικούς τους σε δεκαδική και δεκαεξαδική μορφή.
> - Να συνδυάζετε προγράμματα με ανακατεύθυνση και σωληνώσεις.
>
> **Προαπαιτούμενα:** [Εργαστήριο #3](https://progintro.github.io/lab-material/labs/lab03/) - δομές ελέγχου και επανάληψης.
>
> **Αρχεία που θα φτιάξετε:** `printchar.c`, `pyramid.c`, `lowercase.c`, `encode.c`, `decode.c`
...
- [Άσκηση 1: Εκτύπωση Χαρακτήρων (printchar.c)](#άσκηση-1-εκτύπωση-χαρακτήρων-printcharc)
- [Άσκηση 2: Κατασκευή Πυραμίδας (pyramid.c)](#άσκηση-2-κατασκευή-πυραμίδας-pyramidc)
- [Άσκηση 3: Τροποποίηση Κειμένου (lowercase.c)](#άσκηση-3-τροποποίηση-κειμένου-lowercasec)
- [Άσκηση 4: Κωδικοποίηση και Αποκωδικοποίηση Κειμένου (encode.c και decode.c)](#άσκηση-4-κωδικοποίηση-και-αποκωδικοποίηση-κειμένου-encodec-και-decodec)
