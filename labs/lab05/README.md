...
το μήκος της ακολουθίας collatz για έναν αριθμό.
...
**1.2** Γράψτε σε γλώσσα C μια συνάρτηση
 ...
 το πλήθος των αριθμών της ακολουθίας που ξεκινά από τον `n` και καταλήγει
 στο 1 (συμπεριλαμβανομένων και των δύο). Ολοκληρώστε την υλοποίηση με δομή
 επανάληψης.
...
**1.5 (Advanced - Προαιρετικό)** Κάνετε το πρόγραμμά σας να δέχεται τον
...
n=4 και εξηγήστε την αύξηση του χρόνου υπολογισμού του προγράμματος σε
