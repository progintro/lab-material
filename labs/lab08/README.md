...
>
> - Να χειρίζεστε συμβολοσειρές και να αναγνωρίζετε τον ρόλο του τερματικού `'\0'`.
> - Να χρησιμοποιείτε τις συναρτήσεις της `string.h` και να υλοποιείτε δικές σας εκδοχές τους.
> - Να διαβάζετε ορίσματα από τη γραμμή εντολών μέσω των `argc` και `argv`.
> - Να συνδυάζετε debugger και προσεκτική ανάγνωση για να βρίσκετε σφάλματα μνήμης.
>
> **Προαπαιτούμενα:** [Εργαστήριο #6](https://progintro.github.io/lab-material/labs/lab06/) - δείκτες και πίνακες, [Εργαστήριο #7](https://progintro.github.io/lab-material/labs/lab07/) - δυναμική μνήμη.
>
> **Αρχεία που θα φτιάξετε:** `string.c`, `argcalc.c`, `legolas.c`, `wages.c`
...
- [Άσκηση 1: Επεξεργασία συμβολοσειρών (string.c)](#άσκηση-1-επεξεργασία-συμβολοσειρών-stringc)
- [Άσκηση 2: Ορίσματα γραμμής εντολής (argcalc.c)](#άσκηση-2-ορίσματα-γραμμής-εντολής-argcalcc)
- [Άσκηση 3 (Παλιό θέμα): Πετυχαίνοντας τον στόχο (legolas.c)](#άσκηση-3-παλιό-θέμα-πετυχαίνοντας-τον-στόχο-legolasc)
- [Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 4η)](#παράρτημα-αποσφαλμάτωση-προγραμμάτων-πράξη-4η)
  - [Άσκηση 4: Υπολογισμός μισθών (wages.c)](#άσκηση-4-υπολογισμός-μισθών-wagesc)
...
Σε κάθε επόμενη κλήση της, η `strtok` καλείται με `NULL` στο πρώτο όρισμα και συνεχίζει τη λειτουργία της από το σημείο που η τελευταία κλήση βρήκε τον χαρακτήρα διαχωρισμού. Ένα παράδειγμα χρήσης ακολουθεί με ένα [quote](http://www.quotationspage.com/quote/31293.html):
...
## Άσκηση 2: Ορίσματα γραμμής εντολής (argcalc.c)
...
## Παράρτημα: Αποσφαλμάτωση προγραμμάτων (Πράξη 4η)

Στο προηγούμενο εργαστήριο είδαμε ένα εργαλείο για την αποσφαλμάτωση προγραμμάτων, τον debugger `gdb`. Στο σημερινό εργαστήριο, θα χρησιμοποιήσουμε και πάλι debuggers για να εντοπίσουμε και να διορθώσουμε σφάλματα διαχείρισης μνήμης και, γενικότερα, λογικά σφάλματα που υπάρχουν στα προγράμματά μας.
...
Έστω ότι θέλουμε να υπολογίσουμε το άθροισμα 1+3+5+... για τους πρώτους 20 όρους. Το παρακάτω πρόγραμμα προσπαθεί να αντιμετωπίσει αυτό το πρόβλημα.
...
Αν προσπαθήσουμε λίγο, θα διαπιστώσουμε ότι μετά το τέλος της επανάληψης, το i έχει την τιμή 21, άρα έγινε μια παραπάνω επανάληψη από όσες θέλαμε (το i παίρνει τιμές αρχίζοντας από το 0). Άρα η λύση στο πρόβλημά μας είναι να αλλάξουμε αυτή τη γραμμή κώδικα:
