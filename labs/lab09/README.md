...
- [ΠΑΡΑΡΤΗΜΑ: Αποσφαλμάτωση προγραμμάτων (Πράξη 5η) - valgrind](#παραρτημα-αποσφαλμάτωση-προγραμμάτων-πράξη-5η---valgrind)
  ...
  - [Παράδειγμα 1: παράνομη προσπέλαση (overflow.c)](#παράδειγμα-1-παράνομη-προσπέλαση-overflowc)
  ...
  - [Άσκηση 5.1: Καθαρίστε τις δομές σας](#άσκηση-51-καθαρίστε-τις-δομές-σας)
  - [Άσκηση 5.2: Ξαναδείτε ένα παλιό σφάλμα](#άσκηση-52-ξαναδείτε-ένα-παλιό-σφάλμα)
...
## ΠΑΡΑΡΤΗΜΑ: Αποσφαλμάτωση προγραμμάτων (Πράξη 5η) - valgrind
...
### Παράδειγμα 1: παράνομη προσπέλαση (overflow.c)
...
==2547==    at 0x108808: main (overflow.c:5)
==2547==  Address 0x4a7f054 is 0 bytes after a block of size 20 alloc'd
==2547==    at 0x488545C: malloc (vg_replace_malloc.c:446)
==2547==    by 0x1087F7: main (overflow.c:4)
```

Το `Invalid write of size 4` σημαίνει ότι γράψαμε 4 bytes (το μέγεθος ενός `int`) σε μνήμη που δεν μας ανήκει. Το valgrind μας δίνει **δύο** στοίβες κλήσεων: πού έγινε η παράνομη εγγραφή (`overflow.c:5`) και πού είχε δεσμευτεί το μπλοκ (`overflow.c:4`). Το `0 bytes after a block of size 20` είναι η εξήγηση: δεσμεύσαμε 5 × 4 = 20 bytes και γράψαμε ακριβώς μία θέση παραπέρα.
...
### Άσκηση 5.1: Καθαρίστε τις δομές σας
...
### Άσκηση 5.2: Ξαναδείτε ένα παλιό σφάλμα
