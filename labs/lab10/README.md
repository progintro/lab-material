...
- [ΠΑΡΑΡΤΗΜΑ: Οργάνωση Προγράμματος σε Πολλαπλά Αρχεία](#παραρτημα-οργάνωση-προγράμματος-σε-πολλαπλά-αρχεία)
  ...
  - [Άσκηση: Σπάστε ένα πρόγραμμά σας σε αρθρώματα (more.c)](#άσκηση-σπάστε-ένα-πρόγραμμά-σας-σε-αρθρώματα-morec)
...
## ΠΑΡΑΡΤΗΜΑ: Οργάνωση Προγράμματος σε Πολλαπλά Αρχεία
...
### Άσκηση: Σπάστε ένα πρόγραμμά σας σε αρθρώματα (more.c)
