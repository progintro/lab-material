...
εντολής το όνομα ενός αρχείου κειμένου και προβάλλει τις γραμμές
του αρχείου ανά 20, προτρέποντας τον χρήστη να συνεχίσει, αν επιθυμεί, έως ότου
...
Δημιουργήστε το πρόγραμμα `filediff.c`, το οποίο να δέχεται
